...
{
    [SerializeField] private ObstacleGenerator[] factory; // add factory
    ...
    private void GenerateObstacle(){
        ...
        GameObject newObstacle = factory[obstacleNumber-1].GetObstacle(objectPosition,transform.rotation); // generate obstacle
    ...
    private void GenerateTerrain(){
        ...
        for(int i = 1; i <= terrainLineQuantity; i++){
            ...
            GameObject newObstacle = factory[4].GetObstacle(objectPosition,transform.rotation*Quaternion.Euler(0,90,0)); // generate obstacle
